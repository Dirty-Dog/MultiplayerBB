...
{   
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Move()
        {
            ...
            if (_input.move != Vector2.zero || _input.move == Vector2.zero)
            {
            ...
            {
                _controller.Move(targetDirection.normalized * (0 * Time.deltaTime) +
        ...
        private void JumpAndGravity()
        {
            ...
            if (_verticalVelocity < _terminalVelocity && !Input.GetKey(KeyCode.Mouse1))
            {
